...
const CoachingLanding = () => {
	...
	return (
		<div className="bg-white text-gray-900 min-h-screen">
			...
			<nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-200">
				<div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
					...
					<div className="hidden md:flex gap-8 items-center">
						...
						<a href="#reviews" className="hover:text-blue-600 transition">후기</a>
						<button className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-6 py-2 rounded-full hover:shadow-lg hover:shadow-blue-500/50 transition">
							상담 신청
						</button>
					</div>
				...
				{isMenuOpen && (
					<motion.div 
						...
						className="md:hidden bg-white/95 backdrop-blur-md px-6 py-4 border-t border-gray-200"
					>
						<div className="flex flex-col gap-4">
							<a href="#programs" className="hover:text-blue-600 transition">프로그램</a>
							<a href="#about" className="hover:text-blue-600 transition">소개</a>
							<a href="#reviews" className="hover:text-blue-600 transition">후기</a>
							<button className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-6 py-2 rounded-full w-full">
								상담 신청
							</button>
						</div>
					</motion.div>
			...
			>
				...
				<div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
					...
					<motion.button
						...
						whileTap={{ scale: 0.95 }}
						className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-8 py-4 rounded-full text-lg font-semibold inline-flex items-center gap-2 hover:shadow-2xl hover:shadow-blue-500/50 transition"
					>
						무료 상담 시작하기
						<ArrowRight size={20} />
					</motion.button>
			...
			{/* Programs Section */}
			<section id="programs" className="py-32 px-6 relative bg-gray-50">
					...
					<div className="grid md:grid-cols-3 gap-8">
						{[
							...
							<FadeInSection key={i} delay={i * 0.2}>
								<motion.div
									whileHover={{ y: -10 }}
									className="bg-white backdrop-blur-sm border border-gray-200 rounded-3xl p-8 hover:border-blue-500 hover:shadow-xl transition-all duration-300"
								>
			...
			{/* About Section */}
			<section id="about" className="py-32 px-6 bg-gradient-to-b from-white to-blue-50">
				<div className="max-w-6xl mx-auto">
					<div className="grid md:grid-cols-2 gap-16 items-center">
						<FadeInSection>
							<div className="relative">
								<div className="absolute inset-0 bg-gradient-to-br from-blue-200/30 to-purple-200/30 rounded-3xl blur-2xl" />
								<div className="relative bg-white backdrop-blur-sm border border-gray-200 rounded-3xl p-12 aspect-square flex items-center justify-center">
									<div className="text-center">
										...
										<p className="text-blue-600">전문 코칭 전문가</p>
									</div>
								</div>
							</div>
						</FadeInSection>
					...
					<div className="grid md:grid-cols-3 gap-8">
						{[
							...
							<FadeInSection key={i} delay={i * 0.2}>
								<motion.div
									whileHover={{ y: -5 }}
									className="bg-white backdrop-blur-sm border border-gray-200 rounded-3xl p-8 hover:shadow-xl transition-all duration-300"
								>
									...
									<div className="flex items-center gap-3">
										<div className="w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-xl text-white">
											{review.name[0]}
										</div>
										<div>
			...
			{/* CTA Section */}
			<section className="py-32 px-6 relative overflow-hidden bg-gradient-to-br from-blue-50 to-purple-50">
				...
				<FadeInSection>
					<div className="relative max-w-4xl mx-auto text-center">
						...
						<motion.button
							whileHover={{ scale: 1.05 }}
							whileTap={{ scale: 0.95 }}
							className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-10 py-5 rounded-full text-xl font-semibold inline-flex items-center gap-3 hover:shadow-2xl hover:shadow-blue-500/50 transition"
						>
							무료 상담 신청하기
							<ArrowRight size={24} />
						</motion.button>
